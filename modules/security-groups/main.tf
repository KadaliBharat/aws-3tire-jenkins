resource "aws_security_group" "public_nlb" {
  ...
  tags = { Name = "${var.environment}-public-nlb-sg" }
}
...
resource "aws_security_group" "private_nlb" {
  name        = "${var.environment}-private-nlb-sg"
  description = "Security group for private NLB"
  vpc_id      = var.vpc_id
  ...
  tags = { Name = "${var.environment}-private-nlb-sg" }
}
